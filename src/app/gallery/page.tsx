  ...
  return (
    <main className={`flex flex-col items-center justify-center min-h-screen ${styles.container}`}>
      <div className="max-w-[500px] mx-auto">
        <Card className="bg-[#FFD700] text-black p-6 rounded-3xl overflow-hidden border-4 border-black shadow-[4px_4px_8px_0px_rgba(0,0,0,0.3)]">
          {/* Main Content Area */}
          <div className="bg-white p-5 rounded-xl border-2 border-black">
            {/* Gallery Title */}
            <h1 className="text-[#FFD700] mb-8 text-center" style={{ ...customStyles.pressStart, fontSize: '28px' }}>
              GALLERY
            </h1>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {galleryImages.map((image, index) => (
                <div 
                  key={index} 
                  className="aspect-square relative rounded-xl overflow-hidden bg-gray-100 cursor-pointer group [perspective:1000px]"
                  ...
                  <div className="relative w-full h-full transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                    ...
                    <div className="absolute inset-0 [backface-visibility:hidden]">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-r from-black/30 to-transparent p-4 flex flex-col justify-end">
                        <h3 className="text-white font-bold mb-1" style={{ ...customStyles.pressStart, fontSize: '12px' }}>
                          {image.title}
                        </h3>
